...
const editorConfig = {
    ...
    template: {
        definitions: [
            ...
            {
                title:'Two Column Table Layout - Evenly Distributed',
            ...
            {
                title:'Two Column Table Layout - 60/40',
            ...
            {
                title:'Three Column Table Layout - Evenly Distributed',
