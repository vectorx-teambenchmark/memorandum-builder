...
const colorArray = computed(() => {
  return [
    { color: '#EEEEEE', name: '#EEEEEE' },
    { color: '#AAAAAA', name: '#AAAAAA' },
    { color: '#47B0DE', name: '#47B0DE' },
    { color: '#468FE8', name: '#468FE8' },
    { color: '#5989B2', name: '#5989B2' },
    { color: '#4A7395', name: '#4A7395' },
    { color: '#446988', name: '#446988' },
    { color: '#D5B176', name: '#D5B176' },
    { color: '#B18F6A', name: '#B18F6A' },
    { color: '#B3704F', name: '#B3704F' },
    { color: '#9C9D98', name: '#9C9D98' },
    { color: '#7B7F80', name: '#7B7F80' },
    { color: '#495A6F', name: '#495A6F' },
    { color: '#2C3C49', name: '#2C3C49' },
    ...
    template: {
      definitions: [
        ...
        },
        {
          ...
          description:
            'Four column, two row table set at a table width of 80% for Entity Registration Details',
        ...
        },
        {
          ...
          description:
            'Two column layout for with a table in each column for Key Features and Opportunities.',
        ...
        },
        {
          ...
          description:
            'Two column tableless layout with 2 sections in column 1 and 1 section in column 2',
        ...
        },
        {
          ...
          description:
            'Tableless layout with two rows, the first row is one column, the second row has two columns',
        ...
        },
        {
          ...
          description:
            'Tableless layout with two rows, the first row has two columns, the second has one column',
...
function handleSave(){
    ...
    axios.patch(recordApiUrl,{'Body__c':editor.getData()},{
        headers:{
    ...
    <div class="slds-modal__container">
      ...
      <div class="slds-modal__content slds-p-around_medium slds-modal__content_headless">
        <h2 class="slds-text-heading_large">
          {{ modalText }}
          <span v-if="autoSavePending">
            Content Changed... Please do not navigate away until saving is complete.</span
          >
        </h2>
      </div>
          ...
          <div class="slds-media__body">
            <div class="slds-page-header__name">
              <div class="slds-page-header__name-title">
                <h1>
                  <span class="slds-page-header__title slds-truncate" v-bind:title="contentName">{{
                    contentName
                  }}</span>
                </h1>
                <span
                  v-if="displayPendingSave"
                  class="slds-text-color_destructive slds-page-header__title"
                  >Saving - Please do not navigate away...</span
                >
              </div>
            </div>
          </div>
            ...
            <ul class="slds-button-group-list">
              <li>
                <button
                  ...
                  v-bind:disabled="approvalRequestSubmitted || isPublished"
                  v-on:click="displayRenameContentForm = !displayRenameContentForm"
                >
                  {{ displayRenameContentForm ? 'Cancel Rename Content' : 'Rename Content' }}
                </button>
              </li>
              <li>
                <button
  ...
  <div v-if="displayRenameContentForm" class="slds-grid slds-wrap slds-box slds-theme_default">
    ...
    <div class="slds-col slds-size_1-of-1 slds-var-p-vertical_small">
      <div class="slds-button-group">
        <button class="slds-button slds-button_brand" v-on:click="handleSaveInformation">
          Save
        </button>
        <button
          class="slds-button slds-button_destructive"
          v-on:click="displayRenameContentForm = false"
        >
          Cancel
        </button>
      </div>
